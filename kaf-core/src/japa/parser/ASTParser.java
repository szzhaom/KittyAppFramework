...
final class ASTParser implements ASTParserConstants {
	...
	final public TypeDeclaration TypeDeclaration() throws ParseException {
		...
		TypeDeclaration ret;
		pushJavadoc();
		Comment lastComment = token_source.getLastComment();
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case SEMICOLON:
			jj_consume_token(SEMICOLON);
	...
	final public List ClassOrInterfaceBody(boolean isInterface)
		...
		label_12: while (true) {
			...
			Comment lc = token_source.getLastComment();
			member = ClassOrInterfaceBodyDeclaration(isInterface);
			member.setComment(lc);
			ret.add(member);
		}
		jj_consume_token(RBRACE);
		{
	...
	final public FieldDeclaration FieldDeclaration(Modifier modifier)
		...
		{
			if (true) {
				FieldDeclaration ret = new FieldDeclaration(line, column,
						token.endLine, token.endColumn, popJavadoc(),
						modifier.modifiers, modifier.annotations, type,
						variables);
				return ret;
			}
		}
	...
	final public VariableDeclarator VariableDeclarator() throws ParseException {
		...
		{
			if (true) {
				VariableDeclarator ret = new VariableDeclarator(
						id.getBeginLine(), id.getBeginColumn(), token.endLine,
						token.endColumn, id, init);
				return ret;
			}
		}
		throw new Error("Missing return statement in function");
	...
	final public VariableDeclaratorId VariableDeclaratorId()
		...
		{
			if (true) {
				VariableDeclaratorId ret = new VariableDeclaratorId(line,
						column, token.endLine, token.endColumn, name,
						arrayCount);
				return ret;
			}
		}
	...
	final public MethodDeclaration MethodDeclaration(Modifier modifier)
		...
		{
			if (true) {
				MethodDeclaration ret = new MethodDeclaration(line, column,
						token.endLine, token.endColumn, popJavadoc(),
						modifier.modifiers, modifier.annotations,
						typeParameters, type, name, parameters, arrayCount,
						throws_, block);
				return ret;
			}
		}
	...
	final public ConstructorDeclaration ConstructorDeclaration(Modifier modifier)
		...
		{
			if (true) {
				ConstructorDeclaration ret = new ConstructorDeclaration(line,
						column, token.endLine, token.endColumn, popJavadoc(),
						modifier.modifiers, modifier.annotations,
						typeParameters, name, parameters, throws_,
						new BlockStmt(bbLine, bbColumn, token.endLine,
	...
	final public ExplicitConstructorInvocationStmt ExplicitConstructorInvocation()
		...
		{
			if (true) {
				ExplicitConstructorInvocationStmt ret = new ExplicitConstructorInvocationStmt(
						line, column, token.endLine, token.endColumn, typeArgs,
						isThis, expr, args);
				return ret;
			}
		}
	...
	final public InitializerDeclaration InitializerDeclaration()
		...
		{
			if (true) {
				InitializerDeclaration ret = new InitializerDeclaration(line,
						column, token.endLine, token.endColumn, popJavadoc(),
						isStatic, block);
				return ret;
			}
	...
	final public Expression PrimaryPrefix() throws ParseException {
		...
		case SUPER:
			...
			ret = hasArgs ? new MethodCallExpr(ret.getBeginLine(),
					ret.getBeginColumn(), token.endLine, token.endColumn, ret,
					typeArgs, name, args) : new FieldAccessExpr(
					ret.getBeginLine(), ret.getBeginColumn(), token.endLine,
		...
		default:
			...
			if (jj_2_27(2147483647)) {
				...
				case IDENTIFIER:
					...
					ret = hasArgs ? new MethodCallExpr(line, column,
							token.endLine, token.endColumn, null, null, name,
							args) : new NameExpr(line, column, token.endLine,
	...
	final public Expression AllocationExpression(Expression scope)
		...
		case SHORT:
			...
			if (arr[0] instanceof Integer) {
				ret = new ArrayCreationExpr(line, column, token.endLine,
						token.endColumn, type, ((Integer) arr[0]).intValue(),
						(ArrayInitializerExpr) arr[1]);
			} else {
				ret = new ArrayCreationExpr(line, column, token.endLine,
						token.endColumn, type, (List) arr[0],
			...
			if (jj_2_31(2147483647)) {
				...
				case LT:
					...
					ret = new ObjectCreationExpr(line, column, token.endLine,
							token.endColumn, scope,
							(ClassOrInterfaceType) type, typeArgs, args,
							anonymousBody);
					break;
				default:
					jj_la1[99] = jj_gen;
	...
	final public TryStmt TryStatement() throws ParseException {
		...
		case CATCH:
			label_44: while (true) {
				...
				jj_consume_token(RPAREN);
				catchBlock = Block();
				catchs = add(catchs, new CatchClause(cLine, cColumn,
						token.endLine, token.endColumn, except, catchBlock));
				switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
				case CATCH:
					;
					break;
		...
		{
			if (true) {
				return new TryStmt(line, column, token.endLine,
						token.endColumn, tryBlock, catchs, finallyBlock);
			}
		}
		throw new Error("Missing return statement in function");
	}
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x0, 0x48101000, 0x1, 0x0, 0x0, 0x0, 0x40001000,
				...
				0x0, 0x0, 0x0, 0x0, 0x4a195000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x10000000, 0x0, 0x4a195000, 0x8100000, 0x2094000, 0x4a195000,
				0x0, 0x0, 0x0, 0x22094000, 0x22094000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x42095000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x22094000,
				0x6359f000, 0x0, 0x2094000, 0x2094000, 0x0, 0x2094000,
				0x10000000, 0x10000000, 0x2094000, 0x2094000, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x22094000, 0x0, 0x0, 0x22094000, 0x0,
				0x2094000, 0x0, 0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x20000000, 0x20000000, 0x22094000, 0x0, 0x0, 0x2094000,
				0x0, 0x0, 0x0, 0x2349e000, 0x0, 0x2349e000, 0x0, 0x0, 0x0,
				0x22094000, 0x820000, 0x820000, 0x4000000, 0x62095000,
				0x22094000, 0x22094000, 0x62095000, 0x22094000, 0x0, 0x0, 0x0,
				0x22094000, 0x40000, 0x80000000, 0x80040000, 0x0, 0x0, 0x0,
				0x22094000, 0x22094000, 0x0, 0x4a195000, 0xa194000, 0x4a195000,
				0x800000, };
	}
	...
	private static void jj_la1_init_1() {
		jj_la1_1 = new int[] { 0x20, 0x8899c500, 0x0, 0x0, 0x80000, 0x0,
				...
				0x10, 0x0, 0x0, 0xc89dc781, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0xc89dc781, 0x100, 0x40040281, 0xc89dc781, 0x0, 0x0, 0x0,
				0x51241a81, 0x51241a81, 0x0, 0x0, 0x0, 0x4000000, 0x0, 0x0,
				0x889dc681, 0x0, 0x0, 0x4000000, 0x0, 0x0, 0x51241a81,
				0xfbffdf8b, 0x80000, 0x40281, 0x40281, 0x0, 0x40281, 0x200000,
				0x200000, 0x40281, 0x40040281, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x51241a81, 0x0, 0x0, 0x51241a81, 0x0, 0x40281, 0x0, 0x0,
				0x0, 0x11201800, 0x0, 0x0, 0x0, 0x0, 0x1000800, 0x0,
				0x10001000, 0x10000000, 0x51241a81, 0x0, 0x0, 0x40281, 0x0,
				0x0, 0x0, 0x73e61a8b, 0x0, 0x73e61a8b, 0x0, 0x0, 0x0,
				0x51241a81, 0x0, 0x0, 0x0, 0xd9bdde81, 0x51241a81, 0x51241a81,
				0xd9bdde81, 0x51241a81, 0x0, 0x0, 0x0, 0x51241a81, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x51241a81, 0x51241a81, 0x0, 0x889dc781,
				0x40381, 0x889dc781, 0x0, };
	}

	private static void jj_la1_init_2() {
		jj_la1_2 = new int[] { 0x0, 0x2400000, 0x0, 0x2000000, 0x0, 0x1000000,
				0x2000000, 0x2000000, 0x2400000, 0x0, 0x8000000, 0x0, 0x0,
				0x800000, 0x800000, 0x0, 0x2002000, 0x800000, 0xa442000,
				0x400000, 0x2000000, 0x10000, 0x40000, 0x800000, 0x0, 0x0,
				0xa442000, 0x2000000, 0x8002000, 0xa402000, 0x800000,
				0x4000000, 0x100000, 0x30053846, 0x30053846, 0x800000,
				0x8000000, 0x100000, 0x0, 0x440000, 0x800000, 0x2002000, 0x0,
				0x8000000, 0x0, 0x8000000, 0x8000000, 0x8013846, 0x2453847,
				0x0, 0x0, 0x2000, 0x800000, 0x40002000, 0x0, 0x0, 0x0, 0x2000,
				0x800000, 0x4000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x8000000, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x30013846, 0x30000000, 0x30000000, 0x13846, 0x0, 0x2000,
				0x8000000, 0x10000, 0x10000, 0x11846, 0x2000, 0x1000000,
				0x8000000, 0x10000, 0x0, 0x1100000, 0x1846, 0x0, 0x30013846,
				0x800000, 0x8000000, 0x0, 0x8002000, 0x100000, 0x100000,
				0x453847, 0x80000000, 0x453847, 0x800000, 0x4000000, 0x4000000,
				0x13846, 0x0, 0x0, 0x0, 0x32013846, 0x30013846, 0x30013846,
				0x32413846, 0x30013846, 0x800000, 0x2000, 0x2000, 0x30013846,
				0x0, 0x0, 0x0, 0x2000000, 0x2000, 0x800000, 0x32053846,
				0x32053846, 0x800000, 0x2402000, 0x2002000, 0x2402000, 0x0, };
	}
	...
	private static void jj_la1_init_3() {
		jj_la1_3 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				...
				0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10000000,
				0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0xffe0000, 0x0, 0x10, 0x20, 0x2000, 0x4000,
				0x1000, 0x9, 0x9, 0x0, 0x80000006, 0x80000006, 0x10000, 0x300,
				0x300, 0x8c00, 0x8c00, 0x300, 0x3c0, 0x0, 0x0, 0x0, 0xc0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x0, 0xc0, 0x0,
				0xffe00c0, 0xffe00c0, 0xc0, 0x0, 0x0, 0x0, 0x3c0, 0x3c0, 0x3c0,
				0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x3c0, 0x3c0, 0x0, 0x0, 0x0, 0x0, 0x0, };
	}

	private static void jj_la1_init_4() {
		jj_la1_4 = new int[] { 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
				0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
