			...
			if (k.getIdListVarName() != null) {
				...
				if (t != null) {
					if (t.getLocalCache() != null && !t.getLocalCache().trim().isEmpty()) {
						mce = new MethodCallExpr(new FieldAccessExpr(new NameExpr(t.getJavaClassName() + "Helper"),
								"local" + t.getJavaClassName() + "Map"), "setSourceLastModified", new MethodCallExpr(
						...
						ls.add(new ExpressionStmt(mce));
					} else if (t.getMemcachedConfig() != null) {
