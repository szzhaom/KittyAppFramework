 ...
 * @param <V>
 */
public class VersionMemcachedMap<K extends Serializable, V extends Cachable<K>> extends MemcachedMap<K, V> {
	private Date lastModifiedTime;
	private DateTime lastUpdateVersionDate;

	public VersionMemcachedMap(MemcachedCallback<K, V> callback, MemcachedClient mc, String keyPrefix, Class<V> clazz) {
