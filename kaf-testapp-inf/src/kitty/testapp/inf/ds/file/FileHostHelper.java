...
public class FileHostHelper {
	...
	public static LocalCachedMap<Short, FileHost> localFileHostMap = new LocalCachedMap<Short, FileHost>("filehost",
			mc, localCacheCallBack, itemsChangedEventListener, 1);
	...
	public static void delete(Object caller, Long loginUserId, List<Short> idList) throws Exception {
		...
		FileHostBeanRemote bean = JndiConnectionFactory.lookup("db", caller, Lookuper.JNDI_TYPE_EJB,
				"testappFileHostBean", FileHostBeanRemote.class);
	...
	public static FileHost findById(Object caller, Long loginUserId, Short id) throws Exception {
		...
		FileHost ret = bean.findById(loginUserId, id);
	...
	public static FileHost insert(Object caller, Long loginUserId, FileHost o) throws Exception {
		...
		FileHost ret = bean.insert(loginUserId, o);
	...
	public static FileHost edit(Object caller, Long loginUserId, FileHost o) throws Exception {
		...
		FileHost ret = bean.edit(loginUserId, o);
		// [autogenerated:return(edit) statements=1]
		return ret;
	}

	public static List<FileHost> query(Object caller, Long loginUserId, String cmd, int maxResults, List<?> params)
			throws Exception {
		// [autogenerated:begin(query) statements=1]
		FileHostBeanRemote bean = JndiConnectionFactory.lookup("db", caller, Lookuper.JNDI_TYPE_EJB,
				"testappFileHostBean", FileHostBeanRemote.class);
		// [autogenerated:body(query) statements=1]
		List<FileHost> ret = bean.query(loginUserId, cmd, maxResults, params);
	...
	public static KeyValue<Integer, List<FileHost>> queryPage(Object caller, Long loginUserId, String cmd,
		...
		KeyValue<Integer, List<FileHost>> ret = bean.queryPage(loginUserId, cmd, firstIndex, maxResults, params);
	...
	public static void insertOrEditPageProcess(HttpServletRequest request, HttpServletResponse response) {
		...
		if (id != null) {
			...
			request.setAttribute("data", new FileHost());
		if (error != null)
