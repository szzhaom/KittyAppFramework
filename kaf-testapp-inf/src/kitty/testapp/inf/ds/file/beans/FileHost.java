...
public class FileHost extends IdTableObject<Short> implements LocalCachable<Short> {
    ...
    public static final TableDef tableDef = new TableDef("t_file_host", "文件主机");
    ...
    static {
        ...
        tableDef.getColumns().put("fileHostId", new TableColumnDef(3, "文件主机ID", "file_host_id", 2, 5, 0, false, null, false, 0, false, 1, null, null, null, null, false, false));
        tableDef.getColumns().put("fileHostDesp", new TableColumnDef(4, "文件主机描述", "file_host_desp", 8, 50, 0, false, null, false, 0, true, 1, null, null, "由1~5050个字符组成,一个中文占2个字符", null, false, false));
        tableDef.getColumns().put("ftpHost", new TableColumnDef(5, "FTP主机名", "ftp_host", 8, 50, 0, false, null, false, 0, false, 1, null, null, null, null, false, false));
        tableDef.getColumns().put("ftpPort", new TableColumnDef(6, "FTP端口", "ftp_port", 3, 10, 0, false, null, false, 0, false, 1, null, null, null, null, false, false));
        tableDef.getColumns().put("ftpUser", new TableColumnDef(7, "FTP登录用户", "ftp_user", 8, 50, 0, false, null, false, 0, false, 1, null, null, null, null, false, false));
        tableDef.getColumns().put("ftpPwd", new TableColumnDef(8, "FTP登录密码", "ftp_pwd", 8, 50, 0, false, null, true, 0, false, 1, null, null, null, null, false, false));
        tableDef.getColumns().put("webRoot", new TableColumnDef(9, "http访问根目录", "web_root", 8, 255, 0, false, null, false, 0, false, 1, null, null, null, null, false, false));
    ...
    public void toJson(JSONObject json) throws JSONException {
        ...
        json.put("text", fileHostDesp);
    }

    @Override
    public void doReadFromStream(DataRead stream) throws IOException {
        //[autogenerated:body(doReadFromStream) statements=8]
    ...
    public void doWriteToStream(DataWrite stream) throws IOException {
        //[autogenerated:body(doWriteToStream) statements=8]
    ...
    public void readFromRequest(HttpRequest request, boolean isCreate) throws Exception {
        ...
        setId(tableDef.test("fileHostId", request.getParameterShort("file_host_id"), isCreate));
        setFileHostDesp(tableDef.test("fileHostDesp", request.getParameter("file_host_desp"), isCreate));
        setFtpHost(tableDef.test("ftpHost", request.getParameter("ftp_host"), isCreate));
        setFtpPort(tableDef.test("ftpPort", request.getParameterIntDef("ftp_port", 21), isCreate));
        setFtpUser(tableDef.test("ftpUser", request.getParameter("ftp_user"), isCreate));
        setFtpPwd(tableDef.test("ftpPwd", request.getParameter("ftp_pwd"), isCreate));
        setWebRoot(tableDef.test("webRoot", request.getParameter("web_root"), isCreate));
    }
