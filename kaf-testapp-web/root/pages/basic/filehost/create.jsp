...
<c:div id="createpf" styleClass='content basic_form'
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="file_host_id" add='${data.id==null}' errorPrompt='请输入1到65535之间的数字' normalPrompt='&nbsp;'
			value="${data.fileHostId}" maxLength='5' minLength='1' regExp='' nullable='false'
			minValue='1' maxValue='65535' readOnly='${data.id!=null}' depths='1'
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="file_host_desp" add='${data.id==null}' errorPrompt='输入错误' normalPrompt='&nbsp;'
			value="${data.fileHostDesp}" maxLength='50' minLength='1' regExp='' nullable='false'
			minValue='' maxValue='' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="ftp_host" add='${data.id==null}' errorPrompt='输入错误' normalPrompt='&nbsp;'
			value="${data.ftpHost}" maxLength='50' minLength='1' regExp='' nullable='false'
			minValue='' maxValue='' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="ftp_port" add='${data.id==null}' errorPrompt='请输入1到1000000000之间的数字' normalPrompt='&nbsp;'
			value="${data.ftpPort}" maxLength='10' minLength='1' regExp='' nullable='false'
			minValue='1' maxValue='1000000000' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="ftp_user" add='${data.id==null}' errorPrompt='输入错误' normalPrompt='&nbsp;'
			value="${data.ftpUser}" maxLength='50' minLength='1' regExp='' nullable='false'
			minValue='' maxValue='' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="password" id="ftp_pwd" add='${data.id==null}' errorPrompt='输入错误' normalPrompt='&nbsp;'
			value="${data.ftpPwd}" maxLength='50' minLength='1' regExp='' nullable='false'
			minValue='' maxValue='' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
	...
	<c:div styleClass='row' rendered='true'>
		...
		<i:input type="text" id="web_root" add='${data.id==null}' errorPrompt='输入错误' normalPrompt='&nbsp;'
			value="${data.webRoot}" maxLength='255' minLength='1' regExp='' nullable='false'
			minValue='' maxValue='' readOnly='false' depths='1'
			params="" checkboxes='false' multiSelect='false' url='' textFieldName=''></i:input>
		<c:div styleClass="prompt">
