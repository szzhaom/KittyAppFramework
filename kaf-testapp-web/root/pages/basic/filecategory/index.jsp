...
<c:div styleClass="content" rendered="${mysession.user.right.basicManageEnabled}">
	...
	<script>
		...
		Object.merge(varPrefixL1, {
			...
			search : function() {
				$('search_text').blur();
				this.table.ps['url'] = urlprefix + 'queryFileCategory&keyword='+encodeURIComponent($('search_text').get('value'));
