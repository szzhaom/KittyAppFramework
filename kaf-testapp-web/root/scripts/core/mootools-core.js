...
}else{this.failure();}},isSuccess:function(){var e=this.status;return(e>=200&&e<300);},isRunning:function(){return !!this.running;},processScripts:function(e){if(this.options.evalResponse){return Browser.exec(e);
...
c.tree=b.childNodes;c.elements=b.getElements(e.filter||"*");if(e.filter){c.tree=c.elements;}if(e.update){this.fireEvent('updateElement');var g=document.id(e.update).empty();if(e.filter){g.adopt(c.elements);
