...
public class UserDaoHelper {
    ...
    public static User findById(Dao dao, Long loginUserId, Long id) throws SQLException {
        ...
        if (ret != null) {
            ...
            params.add(id);
            DaoResultSet rset = dao.query("select role_id from t_user_role where user_id=?", 0, params);
            ret.setRoleIdList(rset.getIntList(0));
            rset = dao.query("select role_id from t_user_owner_role where user_id=?", 0, params);
