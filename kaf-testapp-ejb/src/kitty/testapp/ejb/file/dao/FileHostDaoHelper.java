...
public class FileHostDaoHelper {
    ...
    public static void delete(Dao dao, Long loginUserId, List<Short> idList) throws SQLException {
        ...
        if (idList != null && idList.size() > 0) {
            try {
                ...
                if (dao.query(1, SQLHelper.buildSelectOrListSql("t_file_category", "cur_file_host_id", idList), idList).next()) throw new SQLException("还有文件分类使用该主机，不能删除");
            } finally {
        ...
        FileHostHelper.localFileHostMap.setSourceLastModified(dao.getLastModified(FileHost.class, idList));
    }
    ...
    public static FileHost insert(Dao dao, Long loginUserId, FileHost o) throws SQLException {
        ...
        FileHostHelper.localFileHostMap.setSourceLastModified(dao.getLastModified(FileHost.class, ret.getId()));
        return ret;
    }
    ...
    public static List<FileHost> query(Dao dao, Long loginUserId, String cmd, int maxResults, List<?> params) throws SQLException {
        ...
        if (cmd.equalsIgnoreCase("default")) ret = dao.query(FileHost.class, "from t_file_host a where a.is_deleted=0", "", maxResults);
    ...
    public static KeyValue<Integer, List<FileHost>> queryPage(Dao dao, Long loginUserId, String cmd, long firstIndex, int maxResults, List<?> params) throws SQLException {
        ...
        if (cmd.equalsIgnoreCase("default")) ret = dao.keywordQuery(FileHost.class, "from t_file_host a where a.is_deleted=0", "", firstIndex, maxResults, params.get(0));
